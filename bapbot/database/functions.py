...
def log_bap(sql_handle, bapper, bappee, baptype, timestamp):
    ...
    command = "insert into {} (timestamp, bapper, bappee, baptype) VALUES (%(timestamp)s, %(bapper)s, %(bappee)s, %(baptype)s)".format(schema.BapTransSchema.TABLE_NAME)
